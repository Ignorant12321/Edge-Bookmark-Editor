export const zh = {
  ...
  editor: {
    ...
    btn: {
      fetchIconMenu: "网络获取 ▾",
      fetchIcon: "网络获取",
      fetchIconMode: "选择获取方式",
      uploadIcon: "本地上传",
      uploadIconSize: "选择本地图标尺寸",
      moveUp: "上移",
      moveDown: "下移",
      moveTo: "移动到",
      copy: "复制",
  ...
  history: {
    rename: "重命名：{from} -> {to}",
    updateUrl: "修改网址：{title} -> {url}",
    addFolder: "新建文件夹：{title}",
    addBookmark: "添加网址：{title}",
    copy: "复制：{title}",
    delete: "删除：{title}",
    dissolve: "解散：{title} -> {target}",
    moveUp: "上移：{title}",
    moveDown: "下移：{title}",
    moveTo: "移动：{title} -> {target}",
    reorder: "顺序调整：{title}",
    reorderBefore: "顺序调整：{title} 在 {target} 之前",
    reorderAfter: "顺序调整：{title} 在 {target} 之后",
    fetchIcon: "网络获取ICON：{title}",
    uploadIcon: "本地上传ICON：{title}（{size}x{size}）",
    fetchMissingIcons: "获取缺失ICON：成功{success}，失败{failed}",
    undo: "撤销",
    redo: "重做",
    importHtml: "导入：HTML",
    importJson: "导入：JSON",
    loadSample: "载入：预置数据",
    restoreOriginal: "重置：恢复初始数据",
  },
  moveModal: {
    title: "移动到文件夹",
    close: "关闭",
  ...
  alerts: {
    ...
    selectFolderFirst: "请先选中一个文件夹。",
    cannotCopyRoot: "根目录不能复制。",
    cannotDeleteRoot: "根目录不能删除。",
    cannotDissolveRoot: "根目录不能解散。",
    cannotDissolveCurrentFolder: "不能把当前文件夹解散到自己。请先切到其父文件夹或其他文件夹。",
    cannotDissolveIntoDescendant: "不能解散到子文件夹中。",
    confirmDelete: "确定删除“{title}”吗？",
    confirmDissolve: "确定解散“{title}”到“{target}”吗？",
  },
  toasts: {
